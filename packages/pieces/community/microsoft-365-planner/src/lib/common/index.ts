...
const authDesc = `
If you'd like to use your own custom Azure app instead of the default JRNYFLW app, follow the [Azure app creation guide](https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app#register-an-application),
